...
/*
Escreva um programa que simule a distribuição de senhas de atendimento a um grupo
de pessoas. Cada pessoa pode receber uma senha prioritária ou uma senha normal.
Existe apenas 1 atendente, 1 pessoa com senha normal deve ser atendida a cada 3
        ...
        while(true){
            ...
            if(resposta.equals("Y")){
                ...
                if(!senhas.isEmpty()){
                    ...
                    System.out.println("Deseja encerrar o programa (Y/N)");
